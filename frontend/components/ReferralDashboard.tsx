...
export default function ReferralDashboard() {
    ...
    return (
      <CCard>
        <CCardBody className="text-center py-5">
          ...
          <p className="mt-3 text-medium-emphasis">Loading referral information...</p>
        </CCardBody>
      </CCard>
    );
  }
  ...
  if (error || !stats) {
    return (
      <CCard>
        <CCardBody className="text-center py-5">
          <p className="text-danger">{error || 'Unable to load referral information'}</p>
        </CCardBody>
      </CCard>
    );
  }
  ...
  return (
    <div className="referral-dashboard">
      <CCard className="mb-4">
        ...
        <CCardBody>
          <div className="mb-4">
            <h6 className="mb-2">Your Referral Code</h6>
            ...
            <h6 className="mb-2">Share Link</h6>
            ...
            <div className="col-md-4">
              <CCard className="text-center border-start border-primary border-4">
                <CCardBody>
                  ...
                  <div className="text-medium-emphasis small">Total Referrals</div>
                </CCardBody>
              </CCard>
            </div>
            <div className="col-md-4">
              <CCard className="text-center border-start border-success border-4">
                <CCardBody>
                  ...
                  <div className="text-medium-emphasis small">Verified Users</div>
                </CCardBody>
              </CCard>
            </div>
            <div className="col-md-4">
              <CCard className="text-center border-start border-warning border-4">
                <CCardBody>
                  ...
                  <div className="text-medium-emphasis small">Points Earned</div>
                </CCardBody>
              </CCard>
            </div>
          </div>
          ...
          {stats.referrals.length === 0 && (
            <div className="text-center py-4 bg-light rounded">
              ...
              <h6 className="text-medium-emphasis">No referrals yet</h6>
